...
cv2.createTrackbar("Hue Max", "TrackBars", 179, 179, empty)  # 色调最大值滑动条
cv2.createTrackbar("Sat Min", "TrackBars", 0, 255, empty)  # 饱和度最小值滑动条
cv2.createTrackbar("Sat Max", "TrackBars", 255, 255, empty)  # 饱和度最大值滑动条
cv2.createTrackbar("Val Min", "TrackBars", 0, 255, empty)  # 亮度最小值滑动条
...
while 1:
    ...
    img_stack = stackImages(0.7, ([img, mask, img_Result]))
